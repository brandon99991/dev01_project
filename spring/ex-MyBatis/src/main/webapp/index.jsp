...
<div>
	<ul id="menu">
		<li><a href="<c:out value='dept/retrieveDeptList.do' />">
		1) DEPT <Br> @Mapper를 이용한 Mapper 인터페이스 구현 예제 <br>
		    DeptMapper.java <Br>
		    ... <br>
		    @Mapper("deptMapper") <br>
			public interface DeptMapper { <br>
			... <br>
		</a></li><br />
		<li><a href="<c:out value='emp/retrieveEmployeeList.do' />">
		2) EMP <Br> EgovAbstractMapper를 상속한 DAO 구현 예제 <Br>
		    EmpMapper.java <Br>		
			... <br>
			@Repository("empMapper") <Br>
			public class EmpMapper extends EgovAbstractMapper { <Br>
			... <br>
		</a></li>
	</ul>
</div>
